package eu.sergiolopes.nbp.project.newprojectwizard;

import eu.sergiolopes.nbp.project.PlayProjectUtil;
import eu.sergiolopes.nbp.project.general.PlayPanel;
import static eu.sergiolopes.nbp.project.general.PlayPanel.ACTIVATOR_EXECUTABLE_PATH;
...
@TemplateRegistration(folder = "Project/Play",
        ...
        iconBase = "eu/sergiolopes/nbp/play_icon.png")
