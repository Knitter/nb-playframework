...
import eu.sergiolopes.nbp.nodes.testfile.TestFileFilterNode;
...
public class TestFolderFilterNode extends FilterNode {
    ...
    @StaticResource
    public static final String TEST_IMAGE_OPENED_PATH = "eu/sergiolopes/nbp/project/test_folder_open.png";
    public static final Image TEST_IMAGE_OPENED = ImageUtilities.loadImage(TEST_IMAGE_OPENED_PATH);
    @StaticResource
    public static final String TEST_IMAGE_CLOSED_PATH = "eu/sergiolopes/nbp/project/test_folder_closed.png";
