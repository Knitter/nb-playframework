...
public class ViewsPackageFilterNode extends FilterNode {
    ...
    @StaticResource
    public static final String CONF_IMAGE_OPENED_PATH = "eu/sergiolopes/nbp/project/views.png";
    public static final Image IMAGE_OPENED = ImageUtilities.loadImage(CONF_IMAGE_OPENED_PATH);
    @StaticResource
    public static final String CONF_IMAGE_CLOSED_PATH = "eu/sergiolopes/nbp/project/views.png";
