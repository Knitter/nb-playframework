package eu.sergiolopes.nbp.nodes.sbtdependencies.runtime;
...
public class RuntimeParentDependencyNode extends AbstractNode {
    ...
    @StaticResource
    public static final String LIBRARIES_OPENED_IMAGE_PATH = "eu/sergiolopes/nbp/project/libraries_open.png";
    public static final Image LIBRARIES_OPENED_IMAGE = ImageUtilities.loadImage(LIBRARIES_OPENED_IMAGE_PATH);
    @StaticResource
    public static final String LIBRARIES_CLOSED_IMAGE_PATH = "eu/sergiolopes/nbp/project/libraries_closed.png";
