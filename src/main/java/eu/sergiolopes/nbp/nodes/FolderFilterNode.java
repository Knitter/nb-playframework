...
public class FolderFilterNode extends FilterNode {
    ...
    @StaticResource
    public static final String SOURCE_IMAGE_OPENED_PATH = "eu/sergiolopes/nbp/project/folder_open.png";
    public static final Image SOURCE_IMAGE_OPENED = ImageUtilities.loadImage(SOURCE_IMAGE_OPENED_PATH);
    @StaticResource
    public static final String SOURCE_IMAGE_CLOSED_PATH = "eu/sergiolopes/nbp/project/folder_closed.png";
