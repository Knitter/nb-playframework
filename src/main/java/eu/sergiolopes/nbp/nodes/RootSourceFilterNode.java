...
public class RootSourceFilterNode extends FilterNode {
    ...
    @StaticResource
    public static final String ROOT_SOURCE_ICON_PATH = "eu/sergiolopes/nbp/project/root_source.png";
    public static final Image IMAGE_ICON = ImageUtilities.loadImage(ROOT_SOURCE_ICON_PATH);
    @StaticResource
    public static final String ROOT_SOURCE_OPENED_ICON_PATH = "eu/sergiolopes/nbp/project/root_source_open.png";
