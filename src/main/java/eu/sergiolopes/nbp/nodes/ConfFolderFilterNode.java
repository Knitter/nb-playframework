...
public class ConfFolderFilterNode extends FilterNode {
    ...
    @StaticResource
    public static final String CONF_IMAGE_OPENED_PATH = "eu/sergiolopes/nbp/project/conf_folder_open.png";
    public static final Image IMAGE_OPENED = ImageUtilities.loadImage(CONF_IMAGE_OPENED_PATH);
    @StaticResource
    public static final String CONF_IMAGE_CLOSED_PATH = "eu/sergiolopes/nbp/project/conf_folder_closed.png";
