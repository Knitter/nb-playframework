...
import eu.sergiolopes.nbp.filetype.conf.jcclexer.JavaCharStream;
import eu.sergiolopes.nbp.filetype.conf.jcclexer.JavaParserTokenManager;
import eu.sergiolopes.nbp.filetype.conf.jcclexer.Token;
