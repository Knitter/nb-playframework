package eu.sergiolopes.nbp.filetype.scalatemplate.completion;
...
public class ScalaTemplateResourceCompletionItem implements CompletionItem {
    ...
    @StaticResource
    public static final String PATH_IMAGE_ICON_IMAGE = "eu/sergiolopes/nbp/filetype/scalatemplate/imageObject.png";
    private static final ImageIcon IMAGE_ICON_IMAGE = new ImageIcon(ImageUtilities.loadImage(PATH_IMAGE_ICON_IMAGE));
    @StaticResource
    public static final String PATH_IMAGE_ICON_JAVASCRIPT = "eu/sergiolopes/nbp/filetype/scalatemplate/javascript.png";
    private static final ImageIcon IMAGE_ICON_JAVASCRIPT = new ImageIcon(ImageUtilities.loadImage(PATH_IMAGE_ICON_JAVASCRIPT));
    @StaticResource
    public static final String PATH_IMAGE_CSS = "eu/sergiolopes/nbp/filetype/scalatemplate/style_sheet_16.png";
