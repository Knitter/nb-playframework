package eu.sergiolopes.nbp.filetype.scalatemplate.parser;

import eu.sergiolopes.nbp.filetype.scalatemplate.helper.ScalaTemplateLanguageHelper;
import static eu.sergiolopes.nbp.filetype.scalatemplate.helper.ScalaTemplateLanguageHelper.getTranslatedMemberName;
import eu.sergiolopes.nbp.filetype.scalatemplate.helper.ScalaTemplateUtil;
import eu.sergiolopes.nbp.filetype.scalatemplate.helper.TemplateParameter;
import eu.sergiolopes.nbp.filetype.scalatemplate.parser.ScalaTemplateParsingError.ScalaTemplateErrorEnum;
