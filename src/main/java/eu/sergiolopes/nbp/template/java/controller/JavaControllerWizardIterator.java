package eu.sergiolopes.nbp.template.java.controller;

import eu.sergiolopes.nbp.PlayProject;
import static eu.sergiolopes.nbp.project.PlayProjectUtil.PLAY_JAVA_FOLDER_TEMPLATES;
...
@TemplateRegistration(folder = PLAY_JAVA_FOLDER_TEMPLATES, displayName = "#JavaControllerWizardIterator_displayName", iconBase = "eu/sergiolopes/nbp/template/java/class.png", description = "javaController.html")
